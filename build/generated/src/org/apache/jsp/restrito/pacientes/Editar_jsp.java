...
public final class Editar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <hr>\n");
      out.write("            <form action=\"\" method=\"post\"  style=\"width: 500px; height: 400px\">\n");
      out.write("            <table>  \n");
      out.write("            \n");
      out.write("                ID:\n");
      ...
      out.write("              \n");
      out.write("                Cpf:\n");
      out.write("                <input type=\"text\" name=\"txtCpf\"  value=\"");
      out.print( rs.getString("Cpf"));
      out.write("\"/>\n");
      out.write("                 <br>\n");
      out.write("                 \n");
      out.write("                 Telefone:\n");
      out.write("                <input type=\"text\" name=\"txtTelefone\"  value=\"");
      ...
      out.write("                \n");
      out.write("                <a href=\"atualizar.jsp\">Regresar</a>\n");
      out.write("            </form>\n");
      out.write("            ");
}
      out.write("\n");
    ...
    String nome,cpf,telefone,email;
      ...
      email=request.getParameter("txtEmail");
       if(nome!=null && cpf!=null && telefone!=null && email!=null){
           ps=con.prepareStatement("update paciente set Nome='"+nome+"', Cpf='"+cpf+"',Telefone='"+telefone+"', Email='"+email+"'where Id="+id);
           ps.executeUpdate();
